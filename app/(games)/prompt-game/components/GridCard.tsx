...
const GridCard = ({ isPrompt, playerName, answer, avatar, points }: GridCardProps) => {
    ...
    return (
        <div
            className={`${isPrompt ? "bg-blue-500 text-xl font-semibold text-white" : "bg-white"} p-4 border-4 border-black rounded-md relative ${
                !hasPlayer && !isPrompt ? "bg-transparent border-none" : ""
            }`}
        >
            {hasPlayer && (
